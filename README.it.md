...
- Lock condiviso tra processi, al massimo 20 backup locali in chiaro condivisi, verifica del risultato, audit senza il corpo delle note, pannello **Problemi recenti** e diagnostica audit limitata leggibile direttamente da Codex dopo un errore. La versione 0.5.5 accetta fino a 64 KiB in una singola proposta create/append e conserva snapshot UTF-8 esatti basati sulle impostazioni per ogni osservazione transazionale.

## Installazione rapida su Windows

1. Scarica **Obsidian-Bridge-Setup-0.5.5.zip** dalla [pagina delle release](https://github.com/studentepercaso/obsidian-bridge/releases).
...
Usa l'asset il cui nome inizia con **Obsidian-Bridge-Setup**. Gli archivi **Source code** generati automaticamente da GitHub sono copie per sviluppatori, non l'installer guidato. I valori SHA-256 sono pubblicati accanto a ogni release in **SHA256-0.5.5.txt**.
...
- [Note di rilascio bilingui 0.5.5](docs/RELEASE_NOTES_0.5.5.md)
- [Privacy](PRIVACY.md)
