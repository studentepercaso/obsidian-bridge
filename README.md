...
- A guided, high-DPI-aware Windows installer with vault discovery, a self-generated verified local marketplace, and no administrator privileges.
...
Use the asset whose name starts with **Obsidian-Bridge-Setup**. GitHub's automatically generated **Source code** archives are development snapshots, not the guided installer. SHA-256 values are published beside every release in **SHA256-0.5.7.txt**.

The 0.5.7 installer and Bridge Control interface are currently in Italian; the English guide maps each step.
...
```powershell
codex plugin marketplace add studentepercaso/obsidian-bridge --ref 0.5.7
...
- [0.5.7 bilingual release notes](docs/RELEASE_NOTES_0.5.7.md)
- [Privacy](PRIVACY.md)
