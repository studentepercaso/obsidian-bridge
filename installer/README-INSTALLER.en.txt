OBSIDIAN BRIDGE 0.3.2 - READ THIS FIRST
...
The user interface of the 0.3.2 installer and Bridge Control panel is currently
...
enabled for selected folders. Every create or append operation still requires a
