OBSIDIAN BRIDGE 0.5.5 - READ THIS FIRST
...
The user interface of the 0.5.5 installer and Bridge Control panel is currently
...
contents. Version 0.5.5 can show a bounded failure stage and safe cause code,
...
remember up to 100 problems marked as reviewed. Version 0.5.5 uses the same
...
Bridge Control 0.5.5 never launches an executable. Its optional CLI scan only
