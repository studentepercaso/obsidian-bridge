...
Questa guida descrive il pacchetto Windows di Obsidian Bridge 0.5.7. Il flusso normale non richiede PowerShell, modifica di file JSON o variabili d'ambiente.
