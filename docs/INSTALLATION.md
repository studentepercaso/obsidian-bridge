...
Questa guida descrive il pacchetto Windows di Obsidian Bridge 0.5.6. Il flusso normale non richiede PowerShell, modifica di file JSON o variabili d'ambiente.
